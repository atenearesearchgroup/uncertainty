...
// $Id: Value.java 5494 2015-02-05 12:59:25Z lhamann $
...
public abstract class Value implements Comparable<Value>, BufferedToString {
    ...
    /**
     * True if value is an <code>{@link UIntegerValue}</code>
     * @return True if value is an instance of <code>{@link UIntegerValue}</code>
     */
    ...
    /**
     * True if value is an <code>{@link URealValue}</code>
     * @return True if value is an instance of <code>{@link URealValue}</code>
     */
    ...
    /**
     * True if value is a <code>{@link UBooleanValue}</code>
     * @return True if value is an instance of <code>{@link UBooleanValue}</code>
     */
    ...
    /**
     * True if value is a <code>{@link SBooleanValue}</code>
     * @return True if value is an instance of <code>{@link SBooleanValue}</code>
     */
