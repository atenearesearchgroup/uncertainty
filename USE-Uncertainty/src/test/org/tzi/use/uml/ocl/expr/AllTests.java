...
// $Id: AllTests.java 889 2008-04-11 11:52:15Z opti $
...
public class AllTests {
    ...
    public static Test suite() {
        ...
        test.addTestSuite( org.tzi.use.uml.ocl.expr.URealExpOpsTest.class);
        test.addTestSuite( org.tzi.use.uml.ocl.expr.NavigationTest.class );
        test.addTestSuite( org.tzi.use.uml.ocl.expr.UBooleanExpOpsTest.class);
        test.addTestSuite( org.tzi.use.uml.ocl.expr.UIntegerExpOpsTest.class);
        test.addTestSuite( org.tzi.use.uml.ocl.expr.UCollectionExpOpTest.class);
        test.addTestSuite( org.tzi.use.uml.ocl.expr.ExpQueryUncertaintyTest.class);
        return test;
    }
}
